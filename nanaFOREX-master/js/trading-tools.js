...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // 4. Currency Converter (WITH REAL-TIME API)
  ...
  window.calculateRiskReward = function () {
  ...
  // Economic Calendar
  window.loadEconomicCalendar = async function () {
  ...
  window.calculateVolatility = function () {
  ...
  window.calculateMACrossover = function () {
  ...
  let journalEntries = JSON.parse(
    localStorage.getItem("tradingJournal") || "[]",
  );
  ...
  window.cancelJournalEntry = function () {
    const form = document.getElementById("journalForm");
    if (form) {
